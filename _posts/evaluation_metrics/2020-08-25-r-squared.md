...
tags: [machine learning, evaluation metrics, r squared, machine learning glossary]
math: true
toc: true
---
...
Well, R-Squared Adjusted is used for dealing with the addition of variables. You can find R-Squared Adjusted here in <a href="/categories/evaluation-metrics"> Evaluation Metrics.</a><br/>